...
def main():
    ...
    for episode in range(EPISODES):
        ...
        if BASELINE == "PPO":
            ...
            state = substrate_embeddings.mean(
                dim=0
            )

            if state.shape[0] < N_QUBITS:
        ...
        # ======================================
        # Baseline-specific Candidate Count
        # ======================================
        if BASELINE == "PPO":

            k_candidates = 4

        elif BASELINE == "PPO+GAT":

            k_candidates = 6

        elif BASELINE == "Quantum-PPO":

            k_candidates = 8

        elif BASELINE == "DL-ViNE":
    ...
    Plotter.plot_metric(
        ...
        filename=f"{BASELINE}_acceptance_ratio.png"
    )
    ...
    Plotter.plot_metric(
        ...
        filename=f"{BASELINE}_r2c_curve.png"
    )
    ...
    Plotter.plot_metric(
        ...
        filename=f"{BASELINE}_lt_r2c.png"
    )
    ...
    Plotter.plot_metric(
        ...
        filename=f"{BASELINE}_reward_curve.png"
    )
    ...
    Plotter.plot_metric(
        ...
        filename=f"{BASELINE}_policy_entropy.png"
    )
    ...
    Plotter.plot_metric(
        ...
        filename=f"{BASELINE}_training_loss.png"
    )
    ...
    Plotter.plot_metric(
        ...
        filename=f"{BASELINE}_cpu_utilization.png"
    )
    ...
    Plotter.plot_metric(
        ...
        filename=f"{BASELINE}_bw_utilization.png"
    )
